...
fn test_cavp_framework_basic_functionality() {
    ...
    let test_result = crate::cavp::CavpTestResult::new(
        ...
        crate::cavp::CavpTestMetadata {
            environment: crate::cavp::TestEnvironment {
                os: "linux".to_string(),
            ...
            configuration: crate::cavp::TestConfiguration {
                iterations: 1,
...
fn test_nist_documentation_generator_creation() {
    ...
    let test_metadata = crate::cavp::CavpTestMetadata {
        environment: crate::cavp::TestEnvironment {
            os: "linux".to_string(),
            arch: "x86_64".to_string(),
            rust_version: "1.70.0".to_string(),
